...
export class MatrixGroupByMenu extends Component {
    setup() {
    ...
    onGroupBySelected({ itemId, optionId }) {
        ...
        // to change the group-by on the model, only inside the matrix
...
MatrixGroupByMenu.components = {
    CustomGroupByItem,
    Dropdown,
    CheckboxItem,
    PropertiesGroupByItem,
};
MatrixGroupByMenu.template = "matrix_view.MatrixGroupByMenu";
MatrixGroupByMenu.defaultProps = {
    showCaretDown: false,
};
MatrixGroupByMenu.props = {
    ...Dropdown.props,
